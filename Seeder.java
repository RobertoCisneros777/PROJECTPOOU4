...
class Seeder {
    public void initialize() throws ParseException {
        ...
        ControllerAuthor.addAuthor(author1);
        ...
        ControllerAuthor.addAuthor(author2);
        ...
        ControllerAuthor.addAuthor(author3);
        ...
        ControllerUser.addUsers(client);
        Client client1 = new Client(profile4, book1);
        ControllerClient.addClients(client1);
        Transaction transaction1 = new Transaction(uuid.toString(), "PRESTAMO", client1, book1, "09/03/2024");
        ControllerTransaction.addTransaction(transaction1);
        ...
        Client client3 = new Client(profile5, book2);
        client2.borrowedBooks.add(book3);
        ControllerClient.addClients(client3);
        ControllerUser.addUsers(client2);
        ...
        ControllerTransaction.addTransaction(transaction2);
        ControllerTransaction.addTransaction(transaction3);
        ...
        ControllerAdministrator.addAdmins(superAdmin);
        ControllerUser.addUsers(superAdmin);
        ...
        ControllerAdministrator.addAdmins(admin1);
        ControllerUser.addUsers(admin1);
        ...
        ControllerAdministrator.addAdmins(admin2);
        ControllerUser.addUsers(admin2);

        ControllerBook.addBook(book1);
        ControllerBook.addBook(book2);
        ControllerBook.addBook(book3);
        ControllerBook.addBook(book4);
        ControllerBook.addBook(book5);
    }
}